  ...
  needsChange = c(
    ...
    "Unova Control Ltd", "Vector Limited","Vector", "Vinci Construction Grand Projetslink Alliance", "Vinci Construction Grands Projets (city Rail Link)", "Vinci Construction Grands Projets (city Rail Link)", "Vinci Construction - Link Alliance Project", "Vinci Construction Grands Projects S.a.s",
    "Virsae Ltd.", "Vista Entertainment Solutions Limited (vista)", "Vista Group","Vista", "Vista Entertainment Solutions Limited", "Vista Architects", "Vista Entertainment", "Vitaco", "Vodafone New Zealand", "Voluntary Summer Intern And Ecse", "Vuksich  Borich (nz) Ltd", "Vxceed Technologies (nz) Limited",
    "Waitemata District Health Board", "Waka Kotahi New Zealand Transport Agency", "Waste Management Nz Ltd.", "Waste Management New Zealand", "Watercare Services", "Watercare Services Ltd.", "Watercare", "Watercare Services Ltd", "Watts And Hughes Construction", "Wilton Joubert Consulting Engineers", "Wilton Joubert Ltd.",
    "Windcave Limited","Windcave Ltd", "Winstone Wallboards Limited", "Winstone Wallboads", "Woodlynn Ltd", "Woods (wood  Partners Consultants Ltd)","Woods Engineering","Woods Partners And Consultants", "Wsp New Zealand Ltd", "Wsp In New Zealand", "Wsp (materials Lab)", "Wsp New Zealand Limited", "Wsp New Zealand", "Wsp New Zealand",
    "Wsp Nz Limited", "Wsp Opus","Wsp-opus Nz","Wsp-opus", "Xero Limited - Accounting Software", "Xtracta", "Yang Engineering Consultants Limited", "Zenith Tecnica", "Zerojet Limited", "Zero Jet", "Zhye Limited", "Zozo Nz Ltd", "Zyj Group",
    "Connect Digital Services - The University Of Auckland","Faculty Of Engineering, The University Of Auckland",
    "Optometry And Vision Science, The University Of Auckland","Research Assistant At The University Of Auckland","Strong Ai Lab, The University Of Auckland",
    "The Univeristy Of Auckland","The Universiy Of Auckland","University Of Auckland","The University of Auckland", "The University of Auckland"
    )
  ...
  change <- c( 
    ...
    "Connect Digital Services - The University Of Auckland" = "The University Of Auckland",
    "Faculty Of Engineering, The University Of Auckland" = "The University Of Auckland",
    "Optometry And Vision Science, The University Of Auckland" = "The University Of Auckland",
    "Research Assistant At The University Of Auckland" = "The University Of Auckland",
    "Strong Ai Lab, The University Of Auckland" = "The University Of Auckland",
    "The Univeristy Of Auckland" = "The University Of Auckland",
    "The Universiy Of Auckland" = "The University Of Auckland",
    ...
    "Vector Limited" = "Vector Ltd",
    "Vector" = "Vector Ltd",
    "Vinci Construction Grand Projetslink Alliance" = "Vinci",
    "Vinci Construction Grands Projets (city Rail Link)" = "Vinci",
    "Vinci Construction Grands Projets (city Rail Link)" = "Vinci",
    "Vinci Construction - Link Alliance Project" = "Vinci",
    "Vinci Construction Grands Projects S.a.s" = "Dempsey Wood",
    "Virsae Ltd." = "Virsae",
    "Vista Entertainment Solutions Limited (vista)" = "Vista Entertainment Solutions",
    "Vista Group" = "Vista Entertainment Solutions",
    "Vista" = "Vista Entertainment Solutions",
    "Vista Entertainment Solutions Limited" = "Vista Entertainment Solutions",
    "Vista Architects" = "Vista Entertainment Solutions",
    "Vista Entertainment" = "Vista Entertainment Solutions",
    "Vitaco" = "Vitaco Ltd",
    "Vodafone New Zealand" = "Vodafone Nz",
    "Voluntary Summer Intern And Ecse" = "Voluntary Summer Intern At Ecse",
    "Vuksich  Borich (nz) Ltd" = "Dempsey Wood",
    "Vxceed Technologies (nz) Limited" = "Vxceed",
    "Waitemata District Health Board" = "Waitemata Dhb",
    "Waka Kotahi New Zealand Transport Agency" = "Waka Kotahi",
    "Waste Management Nz Ltd." = "Waste Management",
    "Waste Management New Zealand" = "Waste Management",
    "Watercare Services" = "Watercare Services Limited",
    "Watercare Services Ltd." = "Watercare Services Limited",
    "Watercare" = "Watercare Services Limited",
    "Watercare Services Ltd" = "Watercare Services Limited",
    "Watts And Hughes Construction" = "Watts  Hughes Limited",
    "Wilton Joubert Consulting Engineers" = "Wilton Joubert Limited",
    "Wilton Joubert Ltd." = "Wilton Joubert Limited",
    "Windcave Limited" = "Windcave",
    "Windcave Ltd" = "Windcave",
    "Winstone Wallboards Limited" = "Winstone Wallboards",
    "Winstone Wallboads" = "Winstone Wallboards",
    "Woodlynn Ltd" = "Woodlynn",
    "Woods (wood  Partners Consultants Ltd)" = "Woods",
    "Woods Engineering" = "Woods",
    "Woods Partners And Consultants" = "Woods",
    "Wsp New Zealand Ltd" = "Wsp",
    "Wsp In New Zealand" = "Wsp",
    "Wsp (materials Lab)" = "Wsp",
    ...
    "Wsp-opus Nz" = "Wsp",
    "Wsp-opus" = "Wsp",
    "Xero Limited - Accounting Software" = "Xero",
    "Xtracta" = "Xtracta Limited",
    "Yang Engineering Consultants Limited" = "Yang Engineering Consultant Limited",
    "Zenith Tecnica" = "Zenith Tecnica Ltd",
    "Zerojet Limited" = "Zerojet",
    "Zero Jet" = "Zerojet",
    "Zhye Limited" = "Zhye Ltd",
    "Zozo Nz Ltd" = "Zozo New Zealand Ltd",
    "Zyj Group" = "Zyj Group Ltd",
  ...
  Exclude_Auckland_University = c(
    "The University Of Auckland",
    "The University of Auckland"
  )
  
  change_df = change_df[!(change_df$Company.Name %in% Exclude_Auckland_University),]
